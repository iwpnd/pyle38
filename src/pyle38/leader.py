...
class Leader(Follower):
    ...
    async def info(self) -> InfoLeaderResponse:  # ty: ignore[invalid-method-override]
    ...
    # TODO: how can I override supertype Follower here correctly?
    async def server(self) -> ServerStatsResponseLeader:  # ty: ignore[invalid-method-override]
